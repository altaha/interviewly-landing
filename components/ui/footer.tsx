    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        */}
        ...
        {/* Bottom area */}
        <div className="sm:flex sm:items-center sm:justify-between py-4 sm:py-8 border-t border-gray-200">
          ...
          <div>
            ...
            {/* Copyrights note */}
            <div className="text-sm text-gray-600 mt-1">&copy; Interviewly.ai. All rights reserved.</div>
          </div>

          {/* Social as */}
          <ul className="flex mt-4 sm:mt-0">
            <li>
              <a href="https://twitter.com/InterviewlyAI" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
